...
#if (LIBCFG_ADC_INTERNAL_CH_DAC)
#define ADC_CH_DAC1                             (13)
#define ADC_CH_DAC0                             (14)
#define IS_ADC_CHANNEL5(CHANNEL)                (((CHANNEL) == ADC_CH_DAC1) || ((CHANNEL) == ADC_CH_DAC0))
#else
#define IS_ADC_CHANNEL5(CHANNEL)                (0)
#endif

#if (LIBCFG_ADC_IVREF)
#define ADC_CH_IVREF                            (15)
#define IS_ADC_CHANNEL3(CHANNEL)                ((CHANNEL) == ADC_CH_IVREF)
#elif (LIBCFG_ADC_IVREF_CH_V01)
#define ADC_CH_IVREF                            (12)
#define ADC_CH_MVDDA                            (13)
#define IS_ADC_CHANNEL3(CHANNEL)                (((CHANNEL) == ADC_CH_IVREF) || ((CHANNEL) == ADC_CH_MVDDA))
#else
...
#define IS_ADC_CHANNEL6(CHANNEL)                (((CHANNEL) == ADC_CH_GND_VREF) || ((CHANNEL) == ADC_CH_VDD_VREF))
#elif (LIBCFG_ADC_INTERNAL_CH_V03)
#define ADC_CH_GND_VREF                         (16)
#define ADC_CH_MVDDA                            (17)
#define IS_ADC_CHANNEL6(CHANNEL)                (((CHANNEL) == ADC_CH_GND_VREF) || ((CHANNEL) == ADC_CH_MVDDA))
#else
#define ADC_CH_GND_VREF                         (16)
...
#define IS_ADC_CHANNEL(CHANNEL)                  (IS_ADC_CHANNEL1(CHANNEL) || \
                                                  ...
                                                  IS_ADC_CHANNEL4(CHANNEL) || \
                                                  IS_ADC_CHANNEL5(CHANNEL) || \
                                                  IS_ADC_CHANNEL6(CHANNEL))
...
#define IS_ADC_INPUT_CHANNEL(CHANNEL)           (IS_ADC_CHANNEL1(CHANNEL) || IS_ADC_CHANNEL2(CHANNEL) || IS_ADC_CHANNEL4(CHANNEL))
...
#define IS_ADC_VREF_SEL(SEL)                    ((SEL == ADC_VREF_1V215) || \
                                                 ...
                                                 (SEL == ADC_VREF_2V7))
#elif (LIBCFG_ADC_IVREF_CH_V01)
#define ADC_VREF_1V245                          (0ul << 4)
#define ADC_VREF_2V5                            (1ul << 4)
#define ADC_VREF_3V0                            (2ul << 4)
#define ADC_VREF_4V0                            (3ul << 4)

#define IS_ADC_VREF_SEL(SEL)                    ((SEL == ADC_VREF_1V245) || \
                                                 (SEL == ADC_VREF_2V5)   || \
                                                 (SEL == ADC_VREF_3V0)   || \
                                                 (SEL == ADC_VREF_4V0))
...
#if (LIBCFG_ADC_IVREF) || (LIBCFG_ADC_IVREF_CH_V01)
