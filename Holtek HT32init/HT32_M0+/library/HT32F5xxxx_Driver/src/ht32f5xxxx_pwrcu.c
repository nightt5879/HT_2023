...
#define Set_WUP0IEN       SetBit_BB((u32)&HT_PWRCU->CR, 9)
#define Reset_WUP0IEN     ResetBit_BB((u32)&HT_PWRCU->CR, 9)

#if (LIBCFG_PWRCU_WAKEUP1)
#define Set_WUP1EN        SetBit_BB((u32)&HT_PWRCU->CR, 10)
#define Reset_WUP1EN      ResetBit_BB((u32)&HT_PWRCU->CR, 10)

#define Set_WUP1IEN       SetBit_BB((u32)&HT_PWRCU->CR, 11)
#define Reset_WUP1IEN     ResetBit_BB((u32)&HT_PWRCU->CR, 11)
#endif

#if (!LIBCFG_NO_PWRCU_V15_READY_SOURCE)
