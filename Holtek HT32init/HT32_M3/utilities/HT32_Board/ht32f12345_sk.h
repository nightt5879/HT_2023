/*********************************************************************************************************//**
 * @file    ht32f12345_sk.h
 * @version $Rev:: 1815         $
 * @date    $Date:: 2019-09-12 #$
 * @brief   The header file of ht32f12345_sk.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F12345_SK_H
#define __HT32F12345_SK_H
...
/** @addtogroup HT32F12345_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F12345_SK_Exported_Constants HT32F12345 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F12345_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F12345_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
#define KEY1_BUTTON_GPIO_PIN        (GPIO_PIN_4)
#define KEY1_BUTTON_AFIO_MODE       (AFIO_MODE_DEFAULT)
#define KEY1_BUTTON_EXTI_CHANNEL    (4)

#define KEY2_BUTTON_GPIO_ID         (GPIO_PC)
#define KEY2_BUTTON_GPIO_PIN        (GPIO_PIN_5)
#define KEY2_BUTTON_AFIO_MODE       (AFIO_MODE_DEFAULT)
#define KEY2_BUTTON_EXTI_CHANNEL    (5)
...
/** @addtogroup HT32F12345_SK_BUZZER
  * @{
  */
...
/** @addtogroup HT32F12345_SK_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F12345_SK_EBI_LCD
  * @{
  */
...
#define LCD_EBI_BL_GPIO_PIN         (GPIO_PIN_9)
...
/** @addtogroup HT32F12345_SK_I2C_EEPROM
  * @{
  */
...
/** @addtogroup HT32F12345_SK_SDIO_SDCARD
  * @{
  */
#define SDCARD_SDIO                 (HT_SDIO)

#define SDCARD_SD_CD_GPIO_ID        (GPIO_PB)
#define SDCARD_SD_CD_GPIO_PIN       (GPIO_PIN_11)
#define SDCARD_SD_CD_AFIO_MODE      (AFIO_FUN_DEFAULT)
#define SDCARD_SD_CD_GPIO_CLK(CK)   (CK.Bit.PB)
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F12345_SK_Exported_Functions HT32F12345 Starter kit exported functions
  * @{
  */
