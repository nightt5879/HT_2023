/*********************************************************************************************************//**
 * @file    ht32f1xxxx_board_01.c
 * @version $Rev:: 1802         $
 * @date    $Date:: 2019-08-24 #$
 * @brief   This file provides firmware functions to manage LEDs, push-buttons
 *          and COM ports and is available on HT32F1xxxx board.
 *************************************************************************************************************
 * @attention
 *
...
/** @defgroup HT32F1xxxx_BOARD HT32F1xxxx_BOARD
  * @brief Provides firmware functions to manage LEDs, push-buttons
  *        and COM ports and is available on HT32F1xxxx Starter kit/Development board.
  * @{
  */


/* Private types -------------------------------------------------------------------------------------------*/
/** @defgroup HT32F1xxxx_BOARD_Private_TypesDefinitions HT32F1xxxx Board private types definitions
  * @{
  */
...
/* Global variables ----------------------------------------------------------------------------------------*/
/** @defgroup HT32F1xxxx_BOARD_Global_Variable HT32F1xxxx Board global variables
  * @{
  */
...
/* Global functions ----------------------------------------------------------------------------------------*/
/** @defgroup HT32F1xxxx_BOARD_Global_Functions HT32F1xxxx Board global functions
  * @{
  */
/*********************************************************************************************************//**
 ...
 *     @arg BUTTON_MODE_WEAK_UP: Button will be connected to WEAK_UP channel
 * @retval None
 ************************************************************************************************************/
void HT32F_DVB_PBInit(BUTTON_TypeDef BUTTON_x, BUTTON_MODE_TypeDef BUTTON_MODE_x)
{
  ...
  if (BUTTON_MODE_x == BUTTON_MODE_EXTI)
  {
    ...
    NVIC_EnableIRQ((IRQn_Type)(EXTI0_IRQn + BUTTON_EXTI_CH[BUTTON_x]));
  }
  #if !(LIBCFC_WEAK_AF1)
  else if (BUTTON_MODE_x == BUTTON_MODE_WEAK_UP)
  {
    HT32F_DVB_GPxConfig(bGpioId, uGpioPin, AFIO_FUN_SYSTEM);
  }
  #endif
}
...
void HT32F_DVB_BuzzerFun(u16 hFreq, u8 bDuty, u32 mode)
{
  ...
  if (mode == 0)
  {
    ...
    #if (!LIBCFG_NO_MCTM0)
    if (BUZZER_TM == HT_MCTM0 || BUZZER_TM == HT_MCTM1)
    {
...
/* Private functions ---------------------------------------------------------------------------------------*/
/** @defgroup HT32F1xxxx_BOARD_Private_Functions HT32F1xxxx Board private functions
  * @{
  */
/*********************************************************************************************************//**
