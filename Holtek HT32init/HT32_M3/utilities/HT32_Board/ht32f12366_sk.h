/*********************************************************************************************************//**
 * @file    ht32f12366_sk.h
 * @version $Rev:: 1815         $
 * @date    $Date:: 2019-09-12 #$
 * @brief   The header file of ht32f12366_sk.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F12366_SK_H
#define __HT32F12366_SK_H
...
/** @addtogroup HT32F12366_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F12366_SK_Exported_Constants HT32F12366 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F12366_SK_LED
  * @{
  */
#define LEDn                        (3)
...
#define LED2_GPIO_ID                (GPIO_PE)
#define LED2_GPIO_PIN               (GPIO_PIN_0)
#define LED2_AFIO_MODE              (AFIO_MODE_DEFAULT)

#define LED3_GPIO_ID                (GPIO_PE)
...
/** @addtogroup HT32F12366_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F12366_SK_BUZZER
  * @{
  */
#define BUZZER_GPIO_ID              (GPIO_PE)
#define BUZZER_AFIO_PIN             (AFIO_PIN_15)
#define BUZZER_AFIO_MODE            (AFIO_FUN_MCTM_GPTM)
#define BUZZER_GPIO_CLK(CK)         (CK.Bit.PE)

#define BUZZER_TM_CLK(CK)           (CK.Bit.GPTM1)
#define BUZZER_TM                   (HT_GPTM1)
...
/** @addtogroup HT32F12366_SK_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F12366_SK_EBI_LCD
  * @{
  */
...
#define LCD_EBI_RS_AFIO_PIN         (AFIO_PIN_8)
...
/** @addtogroup HT32F12366_SK_I2C_EEPROM
  * @{
  */
...
/** @addtogroup HT32F12366_SK_SDIO_SDCARD
  * @{
  */
#define SDCARD_SDIO                 (HT_SDIO)

#define SDCARD_SD_CD_GPIO_ID        (GPIO_PA)
#define SDCARD_SD_CD_GPIO_PIN       (GPIO_PIN_0)
#define SDCARD_SD_CD_AFIO_MODE      (AFIO_FUN_DEFAULT)
#define SDCARD_SD_CD_GPIO_CLK(CK)   (CK.Bit.PA)
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F12366_SK_Exported_Functions HT32F12366 Starter kit exported functions
  * @{
  */
