 ...
 * @brief   The header file of HT32F1656 starter kit.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F1656_SK_H
#define __HT32F1656_SK_H
...
/** @addtogroup HT32F1656_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F1656_SK_Exported_Constants HT32F1656 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F1656_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F1656_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
#define KEY1_BUTTON_GPIO_ID         (GPIO_PE)
...
/** @addtogroup HT32F1656_SK_BUZZER
  * @{
  */
...
/** @addtogroup HT32F1656_SK_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F1656_SK_EBI_LCD
  * @{
  */
...
#define LCD_EBI_RST_GPIO_PIN        (GPIO_PIN_9)
...
/** @addtogroup HT32F1656_SK_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F1656_SK_Exported_Functions HT32F1656 Starter kit exported functions
  * @{
  */
