/*********************************************************************************************************//**
 * @file    ht32f12364_sk.h
 * @version $Rev:: 342          $
 * @date    $Date:: 2017-06-29 #$
 * @brief   The header file of ht32f12364_sk.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F12364_SK_H
#define __HT32F12364_SK_H
...
/** @addtogroup HT32F12364_SK
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F12364_SK_Exported_Constants HT32F12364 Starter kit exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F12364_SK_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F12364_SK_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
/** @addtogroup HT32F12364_SK_BUZZER
  * @{
  */
#define BUZZER_GPIO_ID              (GPIO_PF)
#define BUZZER_AFIO_PIN             (AFIO_PIN_0)
#define BUZZER_AFIO_MODE            (AFIO_FUN_PWM_SCTM)
#define BUZZER_GPIO_CLK(CK)         (CK.Bit.PF)

#define BUZZER_TM_CLK(CK)           (CK.Bit.PWM0)
#define BUZZER_TM                   (HT_PWM0)
#define BUZZER_TM_CHANNEL           (TM_CH_1)
#define BUZZER_IRQn                 (PWM0_IRQn)
/**
  * @}
  */

/** @addtogroup HT32F12364_SK_COM
  * @{
  */
#define COM_NUM                     (2)
...
#define COM2_IRQHandler             (UART0_IRQHandler)
...
/** @addtogroup HT32F12364_SK_SPI_FLASH
  * @{
  */
...
/** @addtogroup HT32F12364_SK_EBI_LCD
  * @{
  */
...
#define LCD_EBI_RS_GPIO_ID          (GPIO_PC)
#define LCD_EBI_RS_AFIO_PIN         (AFIO_PIN_12)
#define LCD_EBI_RS_AFIO_MODE        (AFIO_FUN_EBI)
#define LCD_EBI_RS_ADDR_PIN         (1)
...
/** @addtogroup HT32F12364_SK_I2C_EEPROM
  * @{
  */
#define EEPROM_I2C_CLK(CK)          (CK.Bit.I2C1)
#define EEPROM_I2C                  (HT_I2C1)

#define EEPROM_I2C_SCL_GPIO_ID      (GPIO_PD)
#define EEPROM_I2C_SCL_AFIO_PIN     (AFIO_PIN_1)
#define EEPROM_I2C_SCL_AFIO_MODE    (AFIO_FUN_I2C)

#define EEPROM_I2C_SDA_GPIO_ID      (GPIO_PD)
#define EEPROM_I2C_SDA_AFIO_PIN     (AFIO_PIN_2)
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F12364_SK_Exported_Functions HT32F12364 Starter kit exported functions
  * @{
  */
