/*********************************************************************************************************//**
 * @file    USBD/CCID/ht32_usbd_descriptor.c
 * @version $Rev:: 535          $
...
__ALIGN4 static uc8 guUSB_ConfnDesc[] =
{
  ...
  3,                          // bNumEndpoints       1 Number of endpoints used by this interface
  ...
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  DESC_LEN_CCID,              // bLength             1 Size of this descriptor in bytes
  DESC_TYPE_21_CCID,          // bDescriptorType     1 Functional Descriptor type
  DESC_H2B(0x0100),           // bcdCCID             2 CCID Specification Release Number
  0x00,                       // bMaxSlotIndex       1 The index of the highest available slot on this device
  0x03,                       // bVoltageSupport     1 This value indicates what voltages the CCID can supply to its slots
  0x03, 0x00, 0x00, 0x00,     // dwProtocols         4 RFU and supported protocol types.  
  0xa0, 0x0f, 0x00, 0x00,     // dwDefaultClock      4 Default ICC clock frequency in KHz. 
  0xa0, 0x0f, 0x00, 0x00,     // dwMaximumClock      4 Maximum supported ICC clock frequency in KHz.
  0x00,                       // bNumClockSupported  1 The number of clock frequencies that are supported by the CCID.
  0x80, 0x25, 0x00, 0x00,     // dwDataRate          4 Default ICC I/O data rate in bps  
  0x08, 0xf8, 0x01, 0x00,     // dwMaxDataRate       4 Maximum supported ICC I/O data rate in bps
  0x00,                       // bNumDataRateSupport 1 The number of data rates that are supported by the CCID
  0xfe, 0x00, 0x00, 0x00,     // dwMaxIFSD           4
  0x07, 0x00, 0x00, 0x00,     // dwSynchProtocols    4
  0x00, 0x00, 0x00, 0x00,     // dwMechanical        4
  0xbe, 0x04, 0x04, 0x00,     // dwFeatures          4
  0x0f, 0x01, 0x00, 0x00,     // dwMaxCCIDMsgLength  4 
  0x00,                       // bClassGetResponse   4
  0xff,                       // bClassEnvelope      4
  0x00, 0x00,                 // wLcdLayout          4
  0x00,                       // bPINSupport         4   
  0x01,                       // bMaxCCIDBusySlots   4
  ...
  0x01,                       // bEndpointAddress    1 The address of the endpoint
  ...
  DESC_LEN_EPT,               // bLength             1 Size of this descriptor in bytes
  DESC_TYPE_05_EPT,           // bDescriptorType     1 ENDPOINT Descriptor Type
  0x82,                       // bEndpointAddress    1 The address of the endpoint
                              //                        Bit 3..0: The endpoint number
                              //                        Bit 6..4: Reserved
                              //                        Bit 7   : Direction (0 = Out/1 = In)
  0x02,                       // bmAttribute         1 Endpoint Attribute
  ...
  DESC_LEN_EPT,               // bLength             1 Size of this descriptor in bytes
  DESC_TYPE_05_EPT,           // bDescriptorType     1 ENDPOINT Descriptor Type
  0x83,                       // bEndpointAddress    1 The address of the endpoint
                              //                        Bit 3..0: The endpoint number
                              //                        Bit 6..4: Reserved
                              //                        Bit 7   : Direction (0 = Out/1 = In)
  ...
  0x20,                       // bInterval           1 Interval for polling endpoint
...
__ALIGN4 static uc8 guUSB_StringDescProduct[] =
{
  ...
  /*--------------------------------------------------------------------------------------------------------*/
                              /* Field            Size Description                                          */
                              /*----------------------------------------------------------------------------*/
  DESC_STRLEN(16),            // bLength             1 Size of this descriptor in bytes
  DESC_TYPE_03_STR,           // bDescriptorType     1 STRING Descriptor Type
