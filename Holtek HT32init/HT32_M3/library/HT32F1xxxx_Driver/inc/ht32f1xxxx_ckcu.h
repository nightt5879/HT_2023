...
/* Definitions of ATC search algorithm                                                                      */
#define CKCU_ATC_BINARY_SEARCH        (0UL << 3)
#define CKCU_ATC_LINEAR_SEARCH        (1UL << 3)

#define IS_CKCU_ATC_ALORGITHM(ALGO)   ((ALGO == CKCU_ATC_BINARY_SEARCH) || \
                                       (ALGO == CKCU_ATC_LINEAR_SEARCH))

/* Definitions of ATC frequency tolerance                                                                   */
#define CKCU_ATC_DOUBLE_PRECISION     (0UL << 2)
#define CKCU_ATC_SINGLE_PRECISION     (1UL << 2)

#define IS_CKCU_ATC_PRECISION(PREC)   ((PREC == CKCU_ATC_DOUBLE_PRECISION) || \
                                       (PREC == CKCU_ATC_SINGLE_PRECISION))
#endif
/**
  * @}
  */
