...
#define _PDMA_BLK_LEN             (65536)
#else
#define _PDMA_BLK_LEN             (256)
#endif
...
#if defined(USE_HT32F12364)
#define PDMA_GPTM_CH0             PDMA_CH2                      /*!< GPTM_CH0 PDMA channel number           */
#define PDMA_GPTM_CH1             PDMA_CH0                      /*!< GPTM_CH1 PDMA channel number           */
#define PDMA_GPTM_CH2             PDMA_CH1                      /*!< GPTM_CH2 PDMA channel number           */
#define PDMA_GPTM_CH3             PDMA_CH0                      /*!< GPTM_CH3 PDMA channel number           */
#define PDMA_GPTM_TRIG            PDMA_CH2                      /*!< GPTM_TRIG PDMA channel number          */
#define PDMA_GPTM_UEV             PDMA_CH1                      /*!< GPTM_UEV PDMA channel number           */
#else
...
#if (LIBCFG_PWM0)
#define PDMA_PWM_CH0              PDMA_CH5                      /*!< PWM_CH0 PDMA channel number            */
#define PDMA_PWM_CH1              PDMA_CH3                      /*!< PWM_CH1 PDMA channel number            */
#define PDMA_PWM_CH2              PDMA_CH4                      /*!< PWM_CH2 PDMA channel number            */
#define PDMA_PWM_CH3              PDMA_CH3                      /*!< PWM_CH3 PDMA channel number            */
#define PDMA_PWM_TRIG             PDMA_CH5                      /*!< PWM_TRIG PDMA channel number           */
#define PDMA_PWM_UEV              PDMA_CH4                      /*!< PWM_UEV PDMA channel number            */
#endif
